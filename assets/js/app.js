...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderModuleCards(funcoes) {
        ...
        const areas = {
            ...
            administrativo: { titulo: 'Intranet Administrativo', descricao: 'Processos, documentos e organização.', url: './pages/administrativo-painel.html', roles: ['admin', 'administrativo'], icon: icons.administrativo },

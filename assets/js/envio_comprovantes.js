...
(function() {
    ...
    async function init() {
        try {
            // Busca profissionais ativos que recebem direto do Firestore
            ...
            document.getElementById('form-profissional').innerHTML = optionsHtml;
        } catch (error) {
            console.error("Erro ao buscar profissionais:", error);
            document.getElementById('form-profissional').innerHTML = '<option value="">Erro ao carregar</option>';
        }
        ...
        reader.onload = function() {
            ...
            .then(response => {
                if (response.status === 'success') {
                    // Após sucesso com o Apps Script, salva no Firestore
                    ...
                    return db.collection('comprovantes').add(comprovanteData).then(() => payload); // Passa o payload para o próximo then
                } else {
            ...
            .then(payload => {
                ...
                // Limpa o formulário
                document.getElementById('form-profissional').value = '';
                document.getElementById('form-paciente').value = '';
                document.getElementById('form-valor').value = '';
                document.getElementById('form-arquivo').value = '';
            })
            .catch(error => {
